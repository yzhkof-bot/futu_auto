...
def main():
    ...
    fig.suptitle(f'{ticker} Amazon - 多信号策略买点 (2025)', fontsize=14, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('reports/AMZN_strategy_backtest_2025.png', dpi=150, bbox_inches='tight')
    print(f"\n图表已保存到: reports/AMZN_strategy_backtest_2025.png")
